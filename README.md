...
Полученное значение ROC-AUC = 0.814 свидетельствует о хорошей способности модели различать клиентов, склонных и не склонных к оттоку.

Значение F1-score = 0.594 показывает удовлетворительное качество классификации для задачи с дисбалансом классов.
...
<img width="640" height="480" alt="image" src="https://github.com/user-attachments/assets/8867d572-f812-483c-8fdb-f45049bd614d" />

Показывает способность модели разделять клиентов, склонных и не склонных к оттоку.

### Матрица ошибок

<img width="640" height="480" alt="image" src="https://github.com/user-attachments/assets/ae22c9e4-c3e0-4e04-8f57-986828e23ae4" />

Отображает количество верно и неверно классифицированных объектов.

### Важность признаков

<img width="1000" height="600" alt="image" src="https://github.com/user-attachments/assets/1ecdbe3b-2cf6-4c50-af08-9854cfab800f" />
